...
public class VocherDaThichAdapter extends RecyclerView.Adapter<VocherDaThichAdapter.ViewHolder> {
    private Context context;
    private ArrayList<Voucher> favoriteVoucher = new ArrayList<>();
    ArrayList<Voucher> voucherlikes;
    public VocherDaThichAdapter(Context context, ArrayList<Voucher> voucherlikes) {
