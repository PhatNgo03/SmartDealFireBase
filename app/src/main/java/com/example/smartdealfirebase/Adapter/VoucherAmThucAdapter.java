...
public class VoucherAmThucAdapter extends RecyclerView.Adapter<VoucherAmThucAdapter.VoucherVH> {
   ...
   Listener listener;
    ...
    public VoucherAmThucAdapter(List<Voucher> vouchers, Listener listener) {
    ...
    public VoucherVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new VoucherAmThucAdapter.VoucherVH(itemView);
    }
