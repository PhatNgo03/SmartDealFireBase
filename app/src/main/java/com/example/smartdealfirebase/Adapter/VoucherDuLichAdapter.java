...
public class VoucherDuLichAdapter  extends RecyclerView.Adapter<VoucherDuLichAdapter.VoucherVH>{
    private List<Voucher> vouchers;

    Listener listener;
    FirebaseStorage storage = FirebaseStorage.getInstance();

    public VoucherDuLichAdapter(List<Voucher> vouchers, Listener listener) {
    ...
    public VoucherVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new VoucherDuLichAdapter.VoucherVH(itemView);
    }
    ...
    public interface Listener {
        void setOnInfoClick(Voucher voucher2);
    }
