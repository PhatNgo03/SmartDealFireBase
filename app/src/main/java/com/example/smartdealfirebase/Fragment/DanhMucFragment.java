...
public class DanhMucFragment extends Fragment {
    ...
    TextView searchbtDM,tvDMATDM,tvDanhMucDuLichDM,tvDanhMucSpaDM;

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);

        searchbtDM=view.findViewById(R.id.edtserchDM);
        tvDanhMucDuLichDM=view.findViewById(R.id.tvDMDuLichODM);
        tvDMATDM=view.findViewById(R.id.tvDMAmThucODM);
        tvDanhMucSpaDM=view.findViewById(R.id.tvDanhMucSpaODM);

        tvDMATDM.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        tvDanhMucDuLichDM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        tvDanhMucSpaDM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        searchbtDM.setOnClickListener(new View.OnClickListener() {
            @Override
