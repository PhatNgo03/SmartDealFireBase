...
import com.example.smartdealfirebase.Adapter.VoucherDaThichAdapter;
...
public class DanhSachVoucherDaThichActivity extends AppCompatActivity {
    ...
    VoucherDaThichAdapter voucherDaThichAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VoucherDaThich();
        voucherDaThichAdapter = new VoucherDaThichAdapter(this,vouchers);
